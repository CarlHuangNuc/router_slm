...
class Qwen2MLP(nn.Module):
    def __init__(self, config):
        ...
        self.gate_proj = QuantizeLinear(self.hidden_size, self.intermediate_size, bias=False)
        self.up_proj = QuantizeLinear(self.hidden_size, self.intermediate_size, bias=False)
        self.down_proj = QuantizeLinear(self.intermediate_size, self.hidden_size, bias=False)
...
class Qwen2Attention(nn.Module):
    ...
    def __init__(self, config: Qwen2Config, layer_idx: Optional[int] = None):
        ...
        self.q_proj = QuantizeLinear(self.hidden_size, self.num_heads * self.head_dim, bias=True)
        self.k_proj = QuantizeLinear(self.hidden_size, self.num_key_value_heads * self.head_dim, bias=True)
        self.v_proj = QuantizeLinear(self.hidden_size, self.num_key_value_heads * self.head_dim, bias=True)
        self.o_proj = QuantizeLinear(self.num_heads * self.head_dim, self.hidden_size, bias=False)
