...
def train() -> None:
    ...
    # json_data_path = '/prj/qct/aicechina_scratch/weihuan/workspace/tencent/llm_notebook_ce/Tencent/hunyuan_2b/sys_pipeline/filtered_output_all.jsonl'
    json_data_path = '/prj/qct/aicechina_scratch/weihuan/eval/qwen-nb/llm_notebook_ce/qwen2.5-gptq-llm/sys_pipeline/train_data_new.json'
