...
class Qwen2_5OmniRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        ...
        # So we expand the inv_freq to shape (3, transformers.)
...
QWEN2_5OMNITHINKER_INPUTS_DOCSTRING = r"""
    Args:
        ...
        position_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            ...
            config.n_positions - 1]`. [What are position IDs?](transformers/glossary#position-ids)
...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids=None, unsqueeze_dim=1):
    ...
    def rotate_half_codec(x):
        # x = rearrange(x, "transformers. (d r) -> transformers. d r", r=2)
        ...
        **kwargs,
        ...
        try:
            ...
            if spk_path is not None:
                ...
                logger.warning(f"spk_dict.pt not found in {pretrained_model_name_or_path}. Skipping speaker loading.")
        except Exception as e:
            logger.warning(f"Failed to load spk_dict.pt: {e}. Skipping speaker loading.")
