...
# Hack to fix missing ParallelismConfig in transformers
try:
    ...
    # Inject into transformers.training_args so type resolution works
...
def parser_gen():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to calibration dataset in JSON/JSONL format. If not specified, uses default wikitext dataset.",
    )

    # Model Adapter Arguments
    parser.add_argument(
        "--lora_path",
        type=str,
        default=None,
        help="Path to LoRA adapter weights to load into the model.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Custom prompt for testing model generation after quantization.",
    )
